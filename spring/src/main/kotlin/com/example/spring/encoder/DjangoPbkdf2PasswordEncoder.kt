...
class DjangoPbkdf2PasswordEncoder : PasswordEncoder {
    ...
    companion object {
        ...
        private const val ITERATIONS = 390000
        private const val HASH_WIDTH = 256
        private const val ALGORITHM = "PBKDF2WithHmacSHA256"
    }

    private val saltGenerator: StringKeyGenerator = KeyGenerators.string()
    ...
    override fun encode(rawPassword: CharSequence): String {
        ...
        return listOf(PREFIX, ITERATIONS, salt, encodedHash).joinToString(SEPARATOR)
    }
